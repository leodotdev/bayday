...
const FAQS = [
  {
    ...
    a: "Browse charters on the Find a Boat page, pick a date, choose your party size, and click Request to Book. You can either sign in for a faster checkout or book as a guest with just your name and email.",
  },
  {
